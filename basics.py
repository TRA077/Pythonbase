...
var=2 
print(var)
#This shows that value of variable is not permanent and hanges from 1 to 2.
...
print(b1%b2)#Mod operation:It returns the remainder of the operation and is always positive.Like here we divided 20 by 10 and remaionder is 0.
print(b2%b1)#Since 20 can't divide 10 remainder is 10.

#Srings could also be added
print(a2+a3)
print(a2+" "+a3)#We could add space between the strings using double quotes and space in between them.
c1="Python Programming"
print(c1[10])#This is slicing, here we could get the word in String at the 11th position since in python indexing starts from zero. So it gives 1st g.
